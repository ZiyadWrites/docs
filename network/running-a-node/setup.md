...
These instructions will help you set up a new Nomic Stakenet node from scratch. If you are already running an older Nomic node, follow the [upgrade instructions](upgrading.md) instead.
